...
//
// It splits compound command lines on shell operators (&&, ||, |, ;, &)
// and parses individual commands into structured form (env prefix, command
// name, subcommand, args, redirections).
package shellparse
